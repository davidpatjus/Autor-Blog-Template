    ...
    <nav class="container mx-auto px-5 py-4">
      <div class="flex items-center justify-between">
        ...
        <ul id="menu" class="hidden md:flex md:space-x-6 space-y-2 md:space-y-0 absolute md:static top-14 left-0 w-full md:w-auto bg-white md:bg-transparent shadow-md md:shadow-none md:flex-row flex-col z-50">
          ...
          <li><a href="./blogs.html" class="text-gray-700 md:text-lg font-semibold hover:text-black transition-colors block px-5 py-2">Artículos</a></li>
          <li><a href="./about.html" class="text-gray-700 md:text-lg font-semibold hover:text-black transition-colors block px-5 py-2">Autor</a></li>
          <li><a href="./contact.html" class="text-gray-700 md:text-lg font-semibold hover:text-black transition-colors block px-5 py-2">Contacto</a></li>
        </ul>
      </div>
    </nav>
  </div>
